            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href='<c:url value="${UrlConst.ROLE_ADD }"></c:url>' class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    <c:forEach items="${roleList}" varStatus="loop" var="item">
                                        <tr>
                                            ...
                                            <td>
                                                <a href='<c:url value="${UrlConst.ROLE_EDIT}">
                                                	<c:param name="id" value="${item.id}"/>
                                                </c:url>' class="btn btn-sm btn-primary">Sửa</a>
                                                <a href='<c:url value="${UrlConst.ROLE_DELETE}">
                                                <c:param name="id" value="${item.id }"/>
