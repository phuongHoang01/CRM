<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- Bootstrap Core CSS -->
    ...
    <!-- toast CSS -->
    <link href="<%=request.getContextPath()%>/assets/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="<%=request.getContextPath()%>/assets/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- animation CSS -->
